...
- wdesktop: requires gtk4 python binding and wayland; an attempt to build a desktop icons programs; implemented: basic file operations (copy/cut/paste; drag and drop; rename; trash; delete), item positioning; works in a window;
