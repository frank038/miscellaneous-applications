...
- textedit_qt6 (rich text editor for documents in html format): conversion to pyqt6 from the official Qt examples with many improvements
- qalc_qt6 (basic calculator): conversion to pyqt6 from the official Qt examples with some improvements
